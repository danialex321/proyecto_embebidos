...
osThreadId_t BreakHandle;
const osThreadAttr_t Break_attributes = {
  .name = "Break",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_BreakInput */
/**
* @brief Function implementing the Break thread.
* @param argument: Not used
* @retval None
*/
...
void BreakInput(void *argument)
{
  ...
  /* USER CODE END BreakInput */
}

/* USER CODE BEGIN Header_GearInput */
/**
