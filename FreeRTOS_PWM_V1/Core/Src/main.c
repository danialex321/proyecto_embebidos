...
/* Definitions for PWM_Fade */
osThreadId_t PWM_FadeHandle;
const osThreadAttr_t PWM_Fade_attributes = {
  .name = "PWM_Fade",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_Start_PWM_Fade */
/**
  * @brief  Function implementing the PWM_Fade thread.
